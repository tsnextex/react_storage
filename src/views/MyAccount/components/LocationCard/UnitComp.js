...
import { LocationCardCustomContainer } from './style';
...
export default function UnitComp({
  ...
  return (
    unit && (
      ...
      >
        <LocationCardCustomContainer>

          <section className="locationTop">
            ...
            >
              ...
              >
                <div className={classes.unit_firstRow}>
                  <span className={classes.unit_dimensions} style={{ fontSize: 16 }}>
                    {unit.status === "active"
                      ? `Unit #${unit.unitNumber}:`
                      : unit.dimensions}
                  </span>
                  <span className={classes.unit_size} style={{ fontSize: 16 }}>
                    { unit.status === 'active'
                      ? `${unit.dimensions} | Climate Controlled`
                      : `| Climate Controlled`
                    }
              ...
              <Hidden mdUp>
                <Grid style={{ marginBottom: 10, width: '100%', background: '#F3F3F3', borderRadius: 4, display: 'flex', justifyContent: 'flex-end' }} item>
                  <Button
                    style={{
                      color: "#1B3C92",
                      fontFamily: "Montserrat",
          ...
          <section className="locationBottom">
            <Grid item className={classes.unit_buttonWrapper}>
              {unit.status === "reserved" ? (
                <Link
                  to={{
                ...
                >
                  <Button
                    style={{ height: 36, background: '#1B3C92', boxShadow: 'none', fontSize: 12 }}
                    variant={
