...
export default function MissingUnitsNew(props) {
            ...
            >
              ...
              <Grid item>
                <Typography
                  ...
                  children={
                    "Welcome! Let's get started by finding your account."
                  }
                />
                <Typography
                  variant="body1"
                  ...
                  children={
                    "Enter your email address and phone number or gate access code & unit number."
                  }
                />
              </Grid>
              <Grid
        ...
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            ...
            >
              ...
              {[
                { name: "Belleville - #**24" },
                { name: "Hobe Sound II - #**50" },
                { name: "Newark - #**41" },
              ].map((x) => (
                <Grid item style={{ minWidth: "380px" }}>
                  <Paper
                    style={{
            ...
            >
              ...
              <Grid item>
                ...
                <Typography
                  ...
                  children={
                    "Must be 6 characters or more and must contain at least 1 character from 3 of the following:"
                  }
                />
                <Typography
                  variant="body1"
            ...
            >
              ...
              <Grid item>
                ...
                <Typography
                  ...
                  children={
                    "An email has been sent to example@mail.com with yout account information. Be sure to check your spam folder if you don't receive an email."
                  }
                />
              </Grid>
